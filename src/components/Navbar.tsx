...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      ...
      <nav className="hidden md:block w-[70%] mx-auto rounded-full mt-4 fixed top-0 left-0 right-0 z-50 bg-black/30 backdrop-blur-md py-4 transition-all duration-300 border border-white/10 shadow-2xl shadow-black/20">
